					...
					<div class="col-lg-8 d-none d-lg-block">
						<nav class="mainmenu__nav">
							<ul class="meninmenu d-flex justify-content-start">
								<li class="drop with--one--item"><a href="/store">Home</a></li>
                            ...
                            <div class="table-content wnro__table table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
																				<td class="product-thumbnail"><a href="#"><img src="{{$item->produks->image}}" alt="product img"></a></td>
                                            <td class="product-name"><a href="#">{{($item->produks->name_produk)}}</a></td>
																						<td class="product-price"><span class="amount">{{($item->produks->harga)}}</span></td>
																						<form action="{{ url('/admin/update3', $item->id) }}" method="post"> @method('put') @csrf
                                            <td class="product-quantity"><input type="number" name="qty" value="1"></td>
