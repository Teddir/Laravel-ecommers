				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-6 col-lg-2">
						<ul class="header__sidebar__right d-flex justify-content-end align-items-center">
							<li class="shop_search"><i class="fa fa-search" aria-hidden="true"></i></li>
							<li class="wishlist"><i class="fa fa-heart" aria-hidden="true"></i></li>
							<li class="shopcart"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="product_qun">3</span></a>
		                    ...
		                    <div class="modal-product">
		                        ...
		                        <div class="product-info">
		                            ...
		                            <div class="addtocart-btn">
																	<form action="{{ url('/admin/create3') }}" method="post">@method('post') @csrf
