								...
								<div class="action">
									<div class="actions_inner">
										<ul class="add_to_links">
											...
											<li><a data-toggle="modal" title="Quick View" class="quickview modal-view detail-link" href="#productmodal{{$item->id}}"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a></li>
										<li><a data-toggle="modal" title="Quick View" class="quickview modal-view detail-link" data-target="#productmodal" href=""><i class="fa fa-heart" aria-hidden="true"></i></a></li>
										</ul>
									</div>
								</div>
									...
									<div class="post-meta">
										<ul>
											...
											<li><a href="#"><i class="bi bi-chat-bubble"></i>27</a></li>
																																						...
																																						<!-- Best Sale Area -->
		<section class="best-seel-area pt--80 pb--60" id="bestseller">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
							...
							<div class="footer__widget footer__menu">
								...
								<div class="footer__content">
									...
									<ul class="mainmenu d-flex justify-content-center">
										...
										<li><a href="#allproduk">All Product</a></li>
													...
													<div class="product-info">
															...
															<div class="price-box-3">
																	<div class="s-price-box">
																			<span class="new-price">Harga: {{number_format($item->harga)}}</span>
																		</div>
																		<div class="s-price-box">
																		<span class="old-price">Diskon: {{($item->diskon)}}%</span>
																		</div>
